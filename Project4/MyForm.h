...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Text = L"Перший член і знаменник зростаючої геометричної прогресії дорівнюють відповідно b"
				L"0 i q. Виведіть десять перших членів прогресії.";
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (fabs(q) > 1)
		{
			richTextBox1->AppendText("Перші десять членів зростаючої геометричної пporpeciї\r\n");
